...
enum SceneType { UNKNOWN_SCT, DIRECT_VISION_SINUSOID, DIRECT_VISION_SIMULATION, DIRECT_VISION_SIMULATION_FRAME, OCCLUSION, FOV_MEASUREMENT, RAW_DATA, CALIBRATION_MATRIX, TEST, TEST_TEST };
